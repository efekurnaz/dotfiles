...
opt.sidescrolloff = 0 -- Don't keep columns visible when scrolling horizontally
...
opt.breakindentopt = "shift:2,min:40" -- Fine-tune wrapped line indentation
opt.textwidth = 0 -- Don't auto-break lines while typing (0 = disabled)
opt.wrapmargin = 0 -- Don't auto-break lines at margin
...
opt.guicursor =
	"n-v-c:block,i-ci-ve:ver25,r-cr:hor20,o:hor50,a:blinkwait100-blinkoff100-blinkon100-Cursor/lCursor,sm:block-blinkwait175-blinkoff150-blinkon175"
--[[
Breakdown:
